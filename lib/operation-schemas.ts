  ...
  },
  {
    ...
    steps: [
      { api: "POST /api/internal/inventory",
        body: ["txType=입고", "itemId", "qty", "locationId", "unitPrice", "memo", "txDate"] },
    ],
    cardTitle: "입고 확인",
    cardShow: ["itemId", "qty", "locationId", "unitPrice", "memo"],
  },
  {
    ...
    steps: [
      { api: "POST /api/internal/inventory",
        body: ["txType", "itemId", "qty", "locationId", "refTxNo", "memo", "txDate"] },
    ],
    cardTitle: "출고/불출 확인",
    cardShow: ["itemId", "txType", "refTxNo", "qty", "locationId", "memo"],
  },
  {
